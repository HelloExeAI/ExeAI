...
export interface Note {
  ...
  export const COMMAND_OPTIONS: CommandOption[] = [
    ...
    { command: 'call', label: 'Call', icon: '📞', color: '#EF4444', description: 'Call reminder with agenda', destination: 'Calls' },
  ...
  export interface CalendarEvent {
    ...
    type: 'event' | 'meeting' | 'travel' | 'birthday' | 'reminder';
    description?: string;
    location?: string;
    sourceNoteId?: string; // Reference to the original note that created this event
    color?: string;
  }